...
if __name__ == "__main__":
    plane1 = Hyperplane(normal_vector=Vector(["-0.412", "3.806", "0.728", "5.23"]), constant_term="-3.46")
    plane2 = Hyperplane(normal_vector=Vector(["1.03", "-9.515", "-1.82", "1.2"]), constant_term="8.65")
